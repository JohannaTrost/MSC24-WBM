...
def time_evolution(w_0, P_data, R_data, Snow_0, T_data, cs, alpha, beta, gamma, c_m):
...
def calibration(P_data, R_data, meas_run, calibration_time, cs_values, alpha_values, gamma_values, beta_values, cm_values):
    ...
    parameter_combinations = list(
        itertools.product(cs_values, alpha_values, gamma_values, beta_values, cm_values))
    ...
    for run_number, params in enumerate(parameter_combinations, start=1):
        w_0 = 0.9 * params[0]
        Snow_0 = 0
        output_df = time_evolution(w_0, P_calibration, R_calibration, Snow_0, *params)
        print(params)
